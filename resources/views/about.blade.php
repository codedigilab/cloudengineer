            ...
            <div class="container">
                <div class="row mb-xxl-6 mb-4 flex-row-reverse justify-content-center g-xxl-6 g-4 g-xxl-6 g-4">
                    <div class="col-lg-4 col-md-5 col-sm-8" data-aos="zoom-in-up" data-aos-duration="1000">
                        <div class="cmn-box py-xxl-9 py-xl-9 py-lg-9 py-5 px-xxl-8 px-xl-6 px-lg-4 px-6"
                            data-aos="zoom-in-down" data-aos-duration="2000">
                            <div class="layla-thumb position-relative about-layla m-auto text-center">
                                <img src="asset/images/banner/layla-pro.png" alt="img" class="radius100">
                                <div class="layla-resize">
                                    <img src="asset/images/global/img-resize.png" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="cmn-box py-xxl-13 py-md-13 py-8 px-xxl-15 px-md-12 px-4" data-aos="zoom-in-down"
                ...
                <div class="row g-xxl-6 g-4 mb-xxl-6 mb-4">
                    <div class="col-xl-4 col-lg-6 col-md-6" data-aos="fade-down" data-aos-duration="1200">
                        <div class="cmn-box h-100 py-xxl-8 py-xl-8 py-lg-8 py-5 px-xxl-8 px-xl-6 px-lg-4 px-6">
                            <div class="d-flex align-items-center justify-content-between mb-10">
                                <h5 class="fw_500 n0-color">
                                    My Experience
                                </h5>
                                <a href="asset/images/banner/layla-wife.png" type="button"
                                    class="exprience-download" download>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.32031 11.6797L11.8803 14.2397L14.4403 11.6797" stroke="white"
                                            stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M11.8828 4V14.17" stroke="white" stroke-width="1.5"
                                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                            ...
                            <ul class="about-expritext">
                                <li>
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7 7L12 12L7 17M13 7L18 12L13 17" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>
                                    <span class="n07">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="1400">
                        <div class="cmn-box h-100 py-xxl-8 py-xl-8 py-lg-8 py-5 px-xxl-8 px-xl-6 px-lg-4 px-6">
                            ...
                            <img src="asset/images/global/s-shape1rotate.png" alt="img" class="s-shape2rotate">
                    ...
                    <div class="col-xl-5" data-aos="fade-down" data-aos-duration="1800">
                        <div
                            class="cmn-box h-100 about-countexprience-wrap py-xxl-8 py-xl-8 py-lg-8 py-5 px-xxl-8 px-xl-6 px-lg-4 px-6">

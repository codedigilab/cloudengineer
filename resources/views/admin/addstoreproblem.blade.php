                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><a href="storeproblem" class="btn btn-primary active">
                                        Back</a></h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div id="basic-example">
                                        ...
                                        <section>
                                            <form method="POST" action="{{ route('storeproblem.store') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="laptoptype" class="form-select">
                                                                ...
                                                                <option value="East Patel Nagar">East Patel Nagar
                                                                </option>
                                                                ...
                                                                <option value="Sector 4 Gurgoan">Sector 4 Gurgoan
                                                                </option>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo date('d-m-Y H:i:s'); ?>" name="empcode"
                                                                placeholder="Date">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-phoneno-input">Problem</label>
                                                                <textarea type="text" class="form-control" name="empemailid" placeholder="Problem"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-email-input">Sataus</label>

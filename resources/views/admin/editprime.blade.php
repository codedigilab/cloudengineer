                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div id="basic-example">
                                        ...
                                        <section>
                                            <form method="POST" action="{{ route('prime.update', $row) }}">
                                               @csrf
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-phoneno-input">Email I'd</label>
                                                            <input type="text" class="form-control"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-email-input">Email Password</label>
                                                            <input type="text" class="form-control" 
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-address-input">Prime Password</label>
                                                             <input type="text" class="form-control"
                                                                 name="employname" value="{{ $record[4] }}" 
                                                                placeholder="Prime Password">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-address-input">E-mail Recovery No Two</label>
                                                             <input type="text" class="form-control" 
                                                                 name="designation" value="{{ $record[5] }}" 
                                                                placeholder="E-mail Recovery No Two">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="basicpill-address-input">Recovery E-mail</label>
                                                             <input type="text" class="form-control"
                                                                 name="deviceidname" value="{{ $record[6] }}" 
